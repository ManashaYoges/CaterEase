  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Saved Events & Menus</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      {loading ? (
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
          <Text style={styles.subtitle}>
            Select a past event to duplicate its menu. You'll be able to edit everything before saving.
          </Text>
            ...
            events.map(event => (
              ...
              >
                ...
                <View style={styles.metaRow}>
                  ...
                  <Text style={styles.metaText}>{event.guest_count} Guests</Text>
                </View>
                <View style={styles.metaRow}>
